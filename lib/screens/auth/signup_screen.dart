...
/// Tela de cadastro. Assim como o login, o envio é um placeholder até o app
/// ter uma API de contas real — o formulário e as validações já estão prontos.
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _submit() async {
    ...
    // TODO: substituir por chamada real a uma API de contas quando existir.
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const _AuthHero(
                greeting: 'Junte-se à jornada!',
                tagline: 'Crie sua conta e monte sua própria lista de animes e mangás.',
              ),
              Padding(
